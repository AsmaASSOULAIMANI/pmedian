...
public class usine {
	...
	public static void main(String[] args) throws Exception  {
		...
		try {
			FileInputStream fis = new  FileInputStream(new File ("usine.xlsx"));
			...
			System.out.println(nbf);
					...
					for(java.util.Iterator<Row> ligneIt=feuilleIn.iterator();ligneIt.hasNext();) {
						...
						System.out.println(Integer.parseInt(values.get(1)));
						String sql = String.format("INSERT INTO usine ( name, capacite, xu ,yu) VALUES ('%s','%d','%d','%d')", values.get(0), Integer.parseInt(values.get(1)), Integer.parseInt(values.get(2)),Integer.parseInt(values.get(3)));
